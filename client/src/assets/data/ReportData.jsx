export const ReportData = [
  ...
  },
  {
    ...
    stages: [
      ...
      { color: "rgb(110,191,133)", label: "1_10_ir_100" },
      { color: "rgb(94,174,89)", label: "1_4_250" },
      { color: "rgb(139,145,75)", label: "1_2_500" },
      { color: "rgb(131,118,66)", label: "1_1_1000" },
      { color: "rgb(129,84,53)", label: "2_2000+" },
    ],
